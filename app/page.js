...
const page = () => {
  ...
  let renderTask = (
    <h2 className="text-xl font-semibold">No Available Task for you.</h2>
  );
      ...
      return (
        <>
          <div className="flex justify-between mb-5 items-center p-5">
            ...
            <button
              className="bg-2 text-xl bg-red-500 text-white px-4 py-2 rounded"
              onClick={() => {
                deleteHandler(i);
              }}
            >
  ...
  return (
    <>
      <h1 className="bg-black  text-6xl font-bold p-5 text-white text-center">
        TodoList
      </h1>
      <form onSubmit={submitHandler}>
        ...
        <button className="bg-black py-2 text-2xl px-4 m-8 text-white rounded-md">
          Add Item
        </button>
      </form>
